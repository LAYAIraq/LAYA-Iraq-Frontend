<template>
  <div class="ly-video position-relative">
    <div v-if="data.src">
      <div v-if="isUpload">
        <video :id="id('vid')" data-able-player crossorigin>
...
// import 'ableplayer/thirdparty/modernizr.custom.js'
// import 'ableplayer/thirdparty/js.cookie.js'
// import 'ableplayer/build/ableplayer.min.js'
  ...
  methods: {
    ...
    url: function(type) {
      ...
      if (typeof media === "string") {
        /* file in backend */
        return `${api()}/storage/Disabled and Self-Employed/download/${media}`;
      }
    ...
    src: function(name) {
      ...
      return `${api()}/storage/Disabled and Self-Employed/download/${name}`;
    },
    embedId: function() {
