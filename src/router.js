...
const AdminPanel = () => import('./views/admin-panel')
const CourseDetail = () => import('./views/course-detail')
const CourseEditWrapper = () => import('./views/course-edit-wrapper')
const CourseNavEdit = () => import('./views/edit-course-nav')
const Courses = () => import('./views/courses')
const Flag = () => import('./views/flag')
...
const PasswordReset = () => import('./views/pwd-reset')
