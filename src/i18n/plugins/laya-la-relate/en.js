export default {
    ...
    or audio files. This component is suitable for the \
    to train understanding of interrelationships.</p>\
    <p>In the line "Title", enter the title for the task \
    one. You can also leave this line blank, e.g. if this \
    component is a part of a series of learning tests.</p>\
    ...
    <p>In "Solutions/Relationships" enter all possible answers. \
    These will later be available for selection in the drop-down menu. You can \
    add as many solutions as you like. To do this, use the blue \
    button below the list of solutions. Individual solutions can \
    be removed via the red button.</p>\
    <p>The "Items" include the examples that your participants \
    should be assigned to the correct category. You can enter a URL \
    for an image and for a sound file. Select \
    which of the answer options is correct. \
    Here you can add as many items as you like via the blue button, \
