export default {
    ...
    tooltip: '<p>In this component you can send feedback about \
        ...
        components in a course.</p>\
        <p>In the "Title" line, enter the heading for the \
        Feedback. You can also leave this line blank.</p>\
        ...
        <p>You can add and remove questions at will. \
        To do this, press the blue or red button under "Questions".</p>'
}
